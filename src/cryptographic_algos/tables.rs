...
pub static S2: [u8; 64] = [
    15, 3, 1, 13, 8, 4, 14, 7, 6, 15, 11, 2, 3, 8, 4, 14, 9, 12, 7, 0, 2, 1, 13, 10, 12, 6, 0, 9,
    5, 11, 10, 5, 0, 13, 14, 8, 7, 10, 11, 1, 10, 3, 4, 15, 13, 4, 1, 2, 5, 11, 8, 6, 12, 7, 6, 12,
    9, 0, 3, 5, 2, 14, 15, 9,
];
...
pub static S4: [u8; 64] = [
    7, 13, 13, 8, 14, 11, 3, 5, 0, 6, 6, 15, 9, 0, 10, 3, 1, 4, 2, 7, 8, 2, 5, 12, 11, 1, 12, 10,
    4, 14, 15, 9, 10, 3, 6, 15, 9, 0, 0, 6, 12, 10, 11, 1, 7, 13, 13, 8, 15, 9, 1, 4, 3, 5, 14, 11,
    5, 12, 2, 7, 8, 2, 4, 14,
];
...
pub static BOX_LOOKUP: [usize; 64] = [
    ...
    13, 29, 14, 30, 15, 31, 32, 48, 33, 49, 34, 50, 35, 51, 36, 52, 37, 53, 38, 54, 39, 55, 40, 56,
    41, 57, 42, 58, 43, 59, 44, 60, 45, 61, 46, 62, 47, 63,
];

pub static BOXES: [[u8; 64]; 8] = [S1, S2, S3, S4, S5, S6, S7, S8];
...
pub static LSHIFTS: [u8; 16] = [1, 1, 2, 2, 2, 2, 2, 2, 1, 2, 2, 2, 2, 2, 2, 1];
